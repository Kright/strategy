...
public class LongWay {
    protected final com.vk.lgorsl.gamelogic.world.Map map;
    ...
    public LongWay(com.vk.lgorsl.gamelogic.world.Map map, Cell A, Cell B) {
        this.map = map;
        target = B;
    ...
    int hDistance(Cell c1, Cell c2) { // эвристическая функция расстояния
        return 2 * com.vk.lgorsl.gamelogic.world.Map.getInterval(c1.x - c2.x, c1.y - c2.y) + 2 * c1.getMovindCost();
    }
